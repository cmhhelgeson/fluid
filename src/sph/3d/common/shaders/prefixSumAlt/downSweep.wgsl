...
struct Prefix_Sum_Input_Vec_0Struct {
	value : array< vec4<u32> >
};
@binding( 0 ) @group( 0 )
var<storage, read_write> Prefix_Sum_Input_Vec_0 : Prefix_Sum_Input_Vec_0Struct;
...
struct Prefix_Sum_Output_Vec_0Struct {
	value : array< vec4<u32> >
};
@binding( 2 ) @group( 0 )
var<storage, read_write> Prefix_Sum_Output_Vec_0 : Prefix_Sum_Output_Vec_0Struct;
